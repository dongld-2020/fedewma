...
if __name__ == "__main__":
    ...
    while True:
        algorithm = input("Enter the federated learning algorithm (fedavg, fedprox, fedewma): ").strip().lower()
        if algorithm in ['fedavg', 'fedprox', 'scaffold', 'fedewma']:
            break
        print("Invalid input! Please enter 'fedavg', 'fedprox', or 'fedewma'.")
